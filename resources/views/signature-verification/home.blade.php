  ...
  <div id="signature-app">
    ...
    <div class="p-1">
      <form id="signature-form"
            ...
            method="POST"
            class="max-w-6xl mx-auto mt-10  gap-4 justify-center">
        @csrf

        <div id="signature-blocks" class="flex flex-wrap gap-4">

        <div data-signature-block class="w-1/4 bg-gray-50 border border-gray-300 p-5 flex flex-col space-y-3 rounded-md">
